...
For a complex number, we can image that it is a vector in 2 dimension space. The angle of a complex number is the angle of this vector. It is convenient to calculate operations of complex numbers in Matlab.
